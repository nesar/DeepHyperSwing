...
if __name__ == "__main__":
    ...
    print('  size: ' + str(size)  +  '  rank: ' + str(rank) + '   gpu_local_idx: ' +str(gpu_local_idx) + '   node: ' + str(node))


    
    import tensorflow as tf
    gpus = tf.config.list_physical_devices("GPU")
    print('Number of physical GPUs: '+ str(len(gpus)))
